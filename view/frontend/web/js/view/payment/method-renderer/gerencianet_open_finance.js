  ...
  function (Component, $, messageList, ko) {
    ...
    return Component.extend({
      ...
      carregarDados: function () {
        ...
        $.ajax({
          url: '/gerencianet/ajax/listparticipantsopenfinance', // Substitua pelo caminho correto para sua controller
          type: 'GET',
          dataType: 'json',
          success: function (response) {
            var participantsArray = Object.values(response)[0].map(function (participant) {
              return {
            ...
            self.participants(participantsArray); // Armazenar os dados mapeados na variável observável
          },
